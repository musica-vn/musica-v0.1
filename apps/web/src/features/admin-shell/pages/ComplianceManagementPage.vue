  ...
  <div class="space-y-6">
    ...
    >
      <div class="space-y-3">
        ...
        <div>
          <h1 class="m-0 text-3xl font-semibold tracking-tight !text-slate-950 dark:!text-white">Pháp lý & Kiểm duyệt</h1>
