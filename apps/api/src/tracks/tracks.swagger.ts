...
import {
  ...
  AdminTrackThumbnailUrlResponseDataDto,
...
export class AdminTrackThumbnailUrlResponseDto {
  @ApiProperty({ example: true })
  success: true;
  ...
  @ApiProperty({ type: AdminTrackThumbnailUrlResponseDataDto })
  data: AdminTrackThumbnailUrlResponseDataDto;
