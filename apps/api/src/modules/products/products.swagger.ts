...
import {
  ...
  AdminProductPlatformSettingsDataDto,
...
export class AdminProductPlatformSettingsResponseDto {
  @ApiProperty({ example: true })
  success: true;
  ...
  @ApiProperty({ type: AdminProductPlatformSettingsDataDto })
  data: AdminProductPlatformSettingsDataDto;
